...
const Section10 = () => {
  ...
  return (
    <section
      className="bg-sky-50 px-6 py-8 text-blue-900 relative overflow-hidden z-20 "
      id="ucapan"
    >
          ...
          <form onSubmit={onSubmit}>
            <div className="flex flex-col text-left text-xs">
              ...
              <input
                ...
                name="name"
                id="name"
                className="text-xs rounded md appearance-none border border-primary-2 mt-2"
              />
            </div>
            <div className="flex flex-col text-left text-xs mt-4">
              ...
              <textarea
                ...
                name="message"
                id="message"
                className="rounded text-xs md appearance-none border border-primary-2 mt-2"
              />
            </div>
              ...
              <div className="flex items-center space-x-4">
                <div className="flex text-left items-center text-xs mt-2 space-x-2">
                  <input
                    ...
                    name="is_attend"
                    id="is_attend_1"
                    className="rounded md appearance-none border border-primary-2 "
                  />
            ...
            <div className="px-12 mt-4 flex flex-col justify-center relative z-10">
              <button
                ...
                type="submit"
                className={
                  'bg-primary-1 rounded-full text-sm px-4 py-2 text-white mx-auto mt-4 hover:scale-95 duration-100 ' +
      ...
      <div
        className="px-4 bg-primary-1 mt-6 rounded-lg max-h-[400px] overflow-y-scroll relative z-10 scrollbar-none"
        data-aos="fade-up"
      >
        {messageList.map((msg, index) => (
          <div className="bg-white p-4 rounded-lg my-4" key={String(index)}>
            <div className="flex space-x-2">
              <div className="h-10 w-10 rounded-full bg-primary-2 flex items-center justify-center">
