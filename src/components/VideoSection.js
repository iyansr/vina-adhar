...
const Card = ({ image, videoId }) => {
  ...
  return (
    <>
      <div className="bg-sky-50 rounded-md shadow-md overflow-hidden p-2">
...
const VideoSection = () => {
  return (
    <section className="bg-primary-1 px-6 py-8 text-purple-900 relative overflow-hidden z-20">
